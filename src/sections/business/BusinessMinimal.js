...
const CARDS = [
  {
    ...
    title: '세일즈',
    description:
      '현지 비지니스 경험이 있는 강사분에게 조언을 얻어 성공해 보세요.',
  },
  {
    icon: '/icons/ic_korea.ico',
    title: '면접',
    description: '면접관 경험도 있는 강사분에게 노하우를 배워보세요.',
  },
  {
    icon: '/icons/ic_america.ico',
    title: '창업',
    description: '현지 창업은 현지 경험이 필요하죠 현지인에게 물어보세요.',
  },
];
      ...
      <Container component={MotionViewport}>
        ...
        >
          ...
          <m.div variants={varFade().inDown}>
            <Typography variant="h2">경험있는 현지 조언자는 어떠세요?</Typography>
            <Typography variant="h4" sx={{ textAlign: 'center', mt: 2, color: '#999999' }}>
              언어도 배우고 현지 사업이나 생활도 배워보세요.
            </Typography>
          </m.div>
        </Box>
