...
// firebase
import { requestHelp } from '../../apis/firebase'
  ...
  return (
    ...
    >
      ...
      <Box ref={form} component='form' noValidate onSubmit={sendEmail} >
        ...
        <LoadingButton loading={loading} type='submit' fullWidth variant='contained' color='secondary' sx={{ mt:3, mb:2 }}>Submit</LoadingButton>
      </Box>
